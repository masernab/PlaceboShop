...
class PlaceholderSvg
{
    ...
    private static function svg(string $slug, string $name, int $variant): string
    {
        ...
        foreach ($lines as $index => $line) {
            ...
            $y = $startY + $index * 72;
            $tspans .= "<tspan x=\"400\" y=\"{$y}\">{$escaped}</tspan>";
        }
        ...
        return <<<SVG
            <svg xmlns="http://www.w3.org/2000/svg" width="800" height="1000" viewBox="0 0 800 1000">
              ...
              <text x="400" y="920" text-anchor="middle" font-family="system-ui, sans-serif" font-size="26" letter-spacing="6" fill="{$ink}" opacity="0.6">PLACEBOSHOP</text>
            </svg>
            SVG;
    }
}
